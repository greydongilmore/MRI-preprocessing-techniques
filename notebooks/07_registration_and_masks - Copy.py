...
raw_img_path = os.path.join(BASE_DIR, 'assets', 'sub-001', raw_example)
mask_img_path = os.path.join(BASE_DIR, 'assets', 'sub-001', mask_example)
...
mask_img_path = os.path.join(BASE_DIR, 'assets', 'sub-002', mask_example)
...
ants.write_transform( redTx, '/mnt/c/Users/fisbain/Documents/GitHub/MRI-preprocessing-techniques/assets/sub-002/redTx.txt')
